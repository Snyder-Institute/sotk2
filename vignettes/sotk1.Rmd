...
# This vignette was originally prepared for sotk1 in October 2024
  * While _SOTK_ (a.k.a. sotk1) focused on selecting the optimal number of latent factors from spatial transcriptomics data in a data-driven manner, **sotk2** extends this framework to enable integrative analysis across heterogeneous omics datasets through biologically informed module integration.
  * This vignette is a revised version of the original _SOTK_ vignette, updated to run reproducibly with **sotk2**.
  * **sotk2** is available at <a href="https://github.com/Snyder-Institute/sotk2" target="_blank">https://github.com/Snyder-Institute/sotk2</a>
